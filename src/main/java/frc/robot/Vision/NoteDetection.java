...
public class NoteDetection {
	...
	public static Pose2d getNotePose() {
		...
		Transform2d noteTransform = new Transform2d(
				new Translation2d(translation.getY(), -translation.getX()).rotateBy(RobotState.getGyroYaw()),
				new Rotation2d());
	...
	private static Translation2d convertMeasurement(double tx, double ty) {
		...
		double distX = Math.tan(Rotation2d.fromDegrees(NoteDetectionConstants.limelightMountAngleY + tx)
						.getRadians())
				* distY;
