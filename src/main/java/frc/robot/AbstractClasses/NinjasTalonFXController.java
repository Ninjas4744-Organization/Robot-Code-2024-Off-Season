...
{   
    ...
    public void periodic() {
        ...
        switch (_controlState) {
            case PIDF_POSITION:
                _main.setControl(new PositionVoltage(_profile.calculate(_trapozoidTimer.get(), getEncoder(), getGoal()).position));
                break;

            case PIDF_VELOCITY:
                _main.setControl(new VelocityVoltage(_profile.calculate(_trapozoidTimer.get(), getEncoder(), getGoal()).velocity));
                break;
