...
public abstract class NinjasController {
     ...
     * 
     */
    public void setControl(ControlState _newState, double demand){
        _controlState = _newState;
        _demand = demand;
     ...
     */
    public void stop(){
        setControl(ControlState.PERCENT_OUTPUT,0);
    }

    /**
     * @return velocity of main motor encoder
     */
    public abstract double getVelocity();

    /**
     * @return position of main motor encoder
     */
