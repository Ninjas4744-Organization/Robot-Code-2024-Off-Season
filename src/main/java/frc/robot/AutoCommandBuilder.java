...
public class AutoCommandBuilder {
  ...
  public static void configureAutoBuilder() {
    AutoBuilder.configureHolonomic(
        ...
        RobotState
            ::setRobotPose, // Method to reset odometry (will be called if your auto has a starting
        // pose)
        Swerve.getInstance()::getChassisSpeeds, // ChassisSpeeds supplier. MUST BE ROBOT RELATIVE
        Swerve.getInstance()
            ::drive, // Method that will drive the robot given ROBOT RELATIVE ChassisSpeeds
